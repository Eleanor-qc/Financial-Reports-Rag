    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for page in pdf.pages:
            ...
            for l in lines:
                ...
                if l.get("paragraph_break") and paragraph_buffer:
                    flush(paragraph_buffer, current_item)
                    paragraph_buffer = []

                current_item = item
                paragraph_buffer.append(l["text"])
